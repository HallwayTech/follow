...
//    search using a case insensitive regular expression
    ...
    protected static Result[] textSearch(String term, String text) {
      ...
      Result[] retval = (Result[]) results.toArray(new Result[results.size()]);
      return retval;
    }

    /**
     * Searches <code>text</code> using the provided <code>Pattern</code>
     * 
     * @param p
     * @param text
     * @return
     */
    protected static Result[] regexSearch(Pattern p, String text) {
