...
class NextTab extends FollowAppAction {
  NextTab (FollowApp app) {
    super(
      app, 
      app.resBundle_.getString("action.NextFile.name"),
      app.resBundle_.getString("action.NextFile.mnemonic"),
      app.resBundle_.getString("action.NextFile.accelerator"),
      app.resBundle_.getString("action.NextFile.icon")
    );
  }
  ...
  public void actionPerformed (ActionEvent e) {
    ...
    if (currentIndex < app_.tabbedPane_.getTabCount() - 1) {
