...
public class Configure extends FollowAppAction {
	...
	CfgDialog() {
	    ...
	    // buffer size
	    gbc.gridy = 0;
	    configPanel.add(new JLabel(FollowApp
	    ...
	    JButton bufferSizeInfo = new WhatIsThis(getApp(), FollowApp
	    ...
	    JButton latencyInfo = new WhatIsThis(getApp(), FollowApp
		    .getResourceString("WhatIsThis.latency.title"), FollowApp
	    ...
	    JButton tabPlacementInfo = new WhatIsThis(getApp(), FollowApp
	    ...
	    JButton confirmDeleteInfo = new WhatIsThis(getApp(), FollowApp
	    ...
	    JButton autoScrollInfo = new WhatIsThis(getApp(), FollowApp
	    ...
	    JButton editorInfo = new WhatIsThis(getApp(), FollowApp
		    .getResourceString("WhatIsThis.editor.title"), FollowApp
	    ...
	    JButton tabSizeInfo = new WhatIsThis(getApp(), FollowApp
		    .getResourceString("WhatIsThis.tabSize.title"), FollowApp
