...
public class FindDialog extends JDialog {
	...
	//
	gbc.ipadx = 4;
	findPanel.add(new JLabel(FollowApp
	...
	//
	caseSensitive = new JCheckBox(FollowApp
		.getResourceString("dialog.Find.caseSensitive.label"));
	gbc.gridx = 1;
	gbc.gridy = 1;
	gbc.weightx = 0;
	...
	// add the find button
	//
	findButton = new JButton(FollowApp
		.getResourceString("dialog.Find.findButton.label"));
	...
	clearButton = new JButton(FollowApp
		.getResourceString("dialog.Find.clearButton.label"));
	...
	closeButton = new JButton(FollowApp
		.getResourceString("dialog.Find.closeButton.label"));
